      ...
      <div style={styles.mainGridStyle}>
        ...
        <div style={styles.scrollableColumnStyle}>
          ...
          <GlassCard title='Atmosphere'>
            <div style={styles.cardGridStyle}>
              ...
              <BigMetric icon='mdi:account-question' label='Feels Like' value={formatRawValue(feelsLike.state, 1)} unit='°C' color='#ff5722' />
              <BigMetric icon='mdi:water-percent' label='Humidity' value={formatRawValue(humidity.state, 0)} unit='%' color='#03a9f4' />
              <BigMetric icon='mdi:thermometer-water' label='Dew Point' value={formatRawValue(dewPoint.state, 1)} unit='°C' color='#00bcd4' />
            </div>
          </GlassCard>
        ...
        <div style={styles.scrollableColumnStyle}>
          ...
          <GlassCard title='Pressure Readings'>
            <div style={styles.cardGridStyle}>
              <BigMetric icon='mdi:gauge' label='Barometer' value={formatRawValue(relPressure.state, 1)} unit='hPa' color='#607d8b' />
            </div>
          </GlassCard>
        </div>
        ...
        <div style={styles.scrollableColumnStyle}>
          ...
          <GlassCard title={`Rain Status: ${skyRainSensor.state}`}>
            <div style={styles.cardGridStyle}>
              ...
              <BigMetric icon='mdi:weather-pouring' label='Intensity' value={formatRawValue(precipIntensity.state, 1)} unit='mm/h' color='#00bcd4' />
          ...
          <GlassCard title='Radiation'>
            <div style={styles.cardGridStyle}>
              ...
              <BigMetric icon='mdi:solar-power' label='Irradiance' value={formatRawValue(irradiance.state, 0)} unit='W/m²' color='#ff9800' />
              <BigMetric icon='mdi:brightness-5' label='Station Lux' value={formatRawValue(illuminance.state, 0)} unit='lx' color='#ffc107' />
              <BigMetric icon='mdi:lightbulb-on' label='Sky Lux' value={formatRawValue(skyIlluminance.state, 0)} unit='lx' color='#ffc107' />
            </div>
          </GlassCard>
        </div>
      </div>
